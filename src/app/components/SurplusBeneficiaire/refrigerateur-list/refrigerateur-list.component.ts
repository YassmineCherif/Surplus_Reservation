...
@Component({
  selector: 'app-refrigerateur-list',
   templateUrl: './refrigerateur-list.component.html',
  styleUrl: './refrigerateur-list.component.css'
})

export class RefrigerateurListComponent implements OnInit, OnDestroy {
